# 🍪 Biskit Documentation Website

The Biskit Documentation website is a living, breathing document that contains all of our visual assets (components, iconography, color palettes, grids, templates, responsive behavior, etc). This document evolves and changes as we collaborate with partners and service teams. All of the assets that live in the Design Documentation can also be found on our <a href="http://koek.nl/">Biskit Design Kit</a>.
